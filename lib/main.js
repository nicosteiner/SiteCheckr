 ...
 * Basic Settings
 */
SiteCheckr.settings.analyzeContentScriptFiles = [data.url('scripts/jquery-1.8.3.min.js'),
                                                 data.url('scripts/helper.js'),
                                                 data.url('scripts/rules.js'),
                                                 data.url('scripts/buildin-rules.js'),
       ...
       if(SiteCheckr.autoCheck.enabled) {
           ...
           SiteCheckr.autoCheck.pageMod = require("page-mod").PageMod({
               ...
               onAttach: function onAttach(worker) {
                   if(!Helper.canPageBeChecked(worker.url)) {
...
SiteCheckr.panel = panel.Panel({
    ...
    contentScriptFile: [
        data.url('scripts/jquery-1.8.3.min.js'),
        data.url('scripts/helper.js'),
        data.url('scripts/rules.js'),
